...
class RoleSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $this->syncRole('manajer-ga', [
            ...
            'asset_transfers.read', 'asset_transfers.create', 'asset_transfers.delete', 'asset_transfers.print',
        ...
        $this->syncRole('staf-ga', [
            ...
            'asset_transfers.read', 'asset_transfers.create', 'asset_transfers.print',
